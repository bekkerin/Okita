...
// the sphere controller script is attached to the sphere object. In the inspector for the sphere, you can see the control and the othercontrol as fields.
public class SphereController : MonoBehaviour
{
    ...
    void Start()
    {
        //sphere starts in center of the world	(transform is 0 0 0). Camera is horizontally centered (0), slightly elevated (1), set back (-10)
    }
    ...
    void Update()
    {
        ...
        /* transform.position = new Vector3 ( Control,
                                                Control + Control,
                                                Control * Control);
        */
        ...
        //move the sphere in runtime by changing the values of Control
